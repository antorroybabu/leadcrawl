...
const POSTS = [
  {
    tag: "Tutorial",
    title: "Crawling JavaScript-Heavy SPA Sites with LeadCrawl",
    date: "May 12, 2025",
    read: "5 min read",
    author: "JD",
  },
  {
    tag: "Update",
    title: "Introducing WatchGraph: Monitor Web Changes in Real-Time",
    date: "April 28, 2025",
    read: "3 min read",
    author: "MS",
  },
  {
    tag: "Use Case",
    title: "Building a Market Intelligence Dashboard with LLM Extraction",
    date: "April 15, 2025",
    read: "8 min read",
    author: "AL",
  },
  {
    tag: "Tutorial",
    title: "Using Pydantic Schemas to Enforce JSON Output Shapes",
    date: "March 30, 2025",
    read: "6 min read",
    author: "JD",
  },
  {
    tag: "Company",
    title: "LeadCrawl raises seed round to build the AI web crawler",
    date: "March 10, 2025",
    read: "4 min read",
    author: "MS",
  },
  {
    tag: "Use Case",
    title: "Automating Competitor Price Tracking with CrawlerGraph",
    date: "Feb 22, 2025",
    read: "7 min read",
    author: "AL",
  },
    ...
    activeCategory === "All"
      ...
      : POSTS.filter(
          (p) =>
            ...
            (activeCategory === "Use Cases" && p.tag === "Use Case"),
        );
              ...
              <div className="bg-card border border-white/[0.08] rounded-2xl p-8 md:p-12 relative overflow-hidden hover:border-primary/40 transition-all duration-300">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-base text-foreground/55 mb-8 max-w-3xl leading-relaxed">
                    Today we're thrilled to announce v2 of LeadCrawl. We've
                    completely rebuilt the engine from the ground up to be
                    faster, more reliable, and capable of understanding complex
                    page structures better than ever before.
                  </p>
              ...
              >
                <Link href="#" className="block group h-full">
                  <div className="bg-card/50 border border-white/[0.07] rounded-xl p-6 h-full flex flex-col hover:border-white/[0.14] hover:bg-card transition-all duration-200">
                    <span
                      className={`inline-flex items-center text-xs font-semibold px-2.5 py-1 rounded-md mb-4 self-start ${TAG_COLORS[post.tag] ?? "text-muted-foreground bg-muted"}`}
                    >
                      {post.tag}
                    </span>
